...
public class FilmDbStorageTest {
    ...
    void testUpdateFilm() {
        ...
        var updateRequest = new UpdateFilmRequest();
        updateRequest.setName("Updated Film");
        updateRequest.setDuration(260);
        filmStorage.update(savedFilm, updateRequest);
    ...
    void testAddAndRemoveFilmLike() {
        ...
        Film likedFilm = filmStorage.findById(savedFilm.getId());
        ...
        Film noLikedFilm = filmStorage.findById(savedFilm.getId());
        assertThat(noLikedFilm).isNotNull();
        assertThat(noLikedFilm.getLikes().size()).isEqualTo(0);
    }
}
